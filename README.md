...
Missing requirements (uppercase, lowercase, numbers, special characters, minimum length)
...
Highlights missing password requirements
...
The display if a password is medium in strengh 
...
Encourage users to create strong, hard-to-guess passwords

Future Enhancements
Real-time strength meter (updates while typing)
